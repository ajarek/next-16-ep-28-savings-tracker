...
export default function Home() {
  return (
    <div className='flex flex-col min-h-screen'>
      <main className='flex-1 w-full flex flex-col gap-4 p-4'>
        <section className='max-w-7xl mx-auto  flex flex-col items-center relative gap-8'>
          <div className='text-center z-10'>
            ...
            <h1 className=' text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] max-w-4xl mx-auto mb-8'>
            ...
            <div className='flex gap-4 justify-center'>
              <Button className='bg-linear-to-br from-primary to-primary/80  px-10 h-16 rounded-xl font-bold text-lg shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all'>
                Open Your Vault
              </Button>
              <Button className='flex items-center gap-2 px-10 h-16 rounded-xl font-bold text-lg hover:scale-105 active:scale-95 transition-all group'>
                Live Demo{" "}
          ...
          <div className='w-full max-w-5xl relative z-20 group'>
            ...
            <div className='glass-card rounded-[2rem] p-4 border border-white/5 overflow-hidden shadow-2xl'>
              <div className='-low rounded-2xl overflow-hidden aspect-16/8 flex flex-col'>
                <div className='p-8 flex justify-between items-end'>
                  <div>
                    <p className='text-muted-foreground text-sm font-label uppercase tracking-widest mb-1'>
                      Total Vault Value
                    </p>
                  ...
                  <div className='flex gap-2'>
                    <span className='bg-tertiary/10 text-tertiary text-xs font-bold px-3 py-1 rounded-full'>
                      +12.4%
                    </span>
                  </div>
                </div>
        ...
        <section className='max-w-7xl mx-auto px-8 py-12 border-y border-white/5 -low/30'>
        ...
        <section className='max-w-7xl mx-auto px-8 '>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='p-10 rounded-[2rem] -low border border-white/5  transition-all duration-300 group'>
            ...
            <div className='p-10 rounded-[2rem] border border-primary/20 shadow-2xl shadow-primary/5 group'>
        ...
        <section className='-low py-16 overflow-hidden'>
              ...
              <div className='w-full md:w-7/12 relative'>
                <div className='bg-[#1a1a1a] rounded-[2.5rem] p-8 border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative z-10'>
                  <div className='flex justify-between items-center mb-10'>
                    ...
                    <div className='px-4 py-1 rounded-full text-[10px] text-muted-foreground uppercase tracking-widest font-bold'>
                      Main Dashboard
                    </div>
                  </div>
                  <div className='grid grid-cols-2 gap-6'>
                    <div className='col-span-2 rounded-3xl p-6 border border-white/5'>
          ...
          <div className='bg-linear-to-br from-surface-container-high to-surface-container-lowest rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden border border-white/5'>
            ...
            <div className='relative z-10'>
              <h2 className=' text-4xl md:text-6xl font-extrabold  mb-8 tracking-tighter'>
                Your Future Deserves <br /> A Better Foundation.
              </h2>
              <p className=' text-xl max-w-xl mx-auto mb-12'>
                Join the next generation of private wealth management. Secure
                your spot in the vault.
              </p>
              <Button className='bg-linear-to-br from-primary to-primary/80  px-12 h-16 rounded-2xl font-black text-xl shadow-[0_20px_50px_rgba(255,143,111,0.3)] hover:scale-105 active:scale-95 transition-all duration-300'>
                Open Your Vault
              </Button>
      ...
      <footer className=' w-full py-4 px-8 border-t relative z-20'>
